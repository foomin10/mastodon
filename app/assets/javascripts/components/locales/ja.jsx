const ja = {
  ...
  "compose_form.privacy_disclaimer": "あなたの非公開トゥートは返信先ユーザーが所属する {domains} に送信されます。{domainsCount, plural, one {このサーバー} other {これらのサーバー}}は信頼できますか？投稿のプライバシー保護は Mastodon サーバー内でのみ有効です。{domains} {domainsCount, plural, one {が Mastodon インスタンス} other {が Mastodon インスタンス}}でない場合、あなたの投稿がプライベートなものとして扱われず、ブーストされたり予期しないユーザーに見られる可能性があります。",
  ...
  "home.column_settings.show_reblogs": "ブーストを表示",
  "home.column_settings.show_replies": "返信を表示",
  "home.settings": "カラム設定",
  "lightbox.close": "閉じる",
  ...
  "onboarding.next": "次へ",
  "onboarding.page_one.welcome": "Mastodon へようこそ！",
  "onboarding.page_one.federation": "Mastodon は誰でも参加できる SNS です。",
  "onboarding.page_one.handle": "あなたは今数ある Mastodon インスタンスの1つである {domain} にいます。あなたのフルハンドルは {handle} です。",
  ...
  "onboarding.page_three.profile": "「プロフィールを編集」から、あなたの自己紹介や表示名を変更できます。また、そこでは他の設定ができます。",
  "onboarding.page_four.home": "「ホーム」タイムラインではあなたがフォローしている人の投稿を表示します。",
  "onboarding.page_four.notifications": "「通知」ではあなたへの他の人からの関わりを表示します。",
  "onboarding.page_five.public_timelines": "連合タイムラインでは {domain} の人がフォローしている Mastodon 全体での公開投稿を表示します。同じくローカルタイムラインでは {domain} のみの公開投稿を表示します。",
  "onboarding.page_six.almost_done": "以上です。",
  "onboarding.page_six.admin": "このインスタンスの管理者は {admin} です。",
  "onboarding.page_six.read_guidelines": "{guidelines}を読むことを忘れないようにしてください。",
  "onboarding.page_six.guidelines": "コミュニティガイドライン",
  "onboarding.page_six.github": "Mastodon は OSS です。バグ報告や機能要望あるいは貢献を {github} から行なえます。",
  "onboarding.page_six.apps_available": "iOS、Android あるいは他のプラットフォームで使える{apps}があります。",
  "onboarding.page_six.various_app": "様々なモバイルアプリ",
  "onboarding.skip": "スキップ",
  "privacy.change": "投稿のプライバシーを変更",
  "privacy.direct.long": "返信したユーザーにだけ公開",
  "privacy.direct.short": "ダイレクト",
  "privacy.private.long": "フォロワーにだけ公開",
  "privacy.private.short": "プライベート",
  "privacy.public.long": "公開TLに投稿する",
  "privacy.public.short": "公開",
  "privacy.unlisted.long": "公開TLに表示しない",
  "privacy.unlisted.short": "非掲載",
